  ...
  return (
    <div className="bg-white dark:bg-zinc-900 rounded-xl shadow-sm border border-gray-200 dark:border-zinc-800 p-6 sticky top-6">
      ...
      <form action={async (formData) => {
        ...
        {selectedOutil && (
          <div className="p-3 bg-gray-50 dark:bg-zinc-950 rounded-lg border border-gray-100 dark:border-zinc-800 text-sm">
            <span className="font-semibold text-gray-900 dark:text-zinc-50">{selectedOutil.nom}</span>
        ...
        {actionType === 'Emprunt' && (
          <div>
            ...
            <select name="chantierId" required className="w-full rounded-md border border-gray-300 dark:border-zinc-700 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">
